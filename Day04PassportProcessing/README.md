...
* [Advent of Code - Day 4: Passport Processing](https://adventofcode.com/2020/day/4)
* [Microsoft - Regex Class](https://docs.microsoft.com/en-us/dotnet/api/system.text.regularexpressions.regex?view=net-5.0)
* [Stack Overflow - How do I get the last four characters from a string in C#?](https://stackoverflow.com/questions/6413572/how-do-i-get-the-last-four-characters-from-a-string-in-c)
* [Stack Overflow - Regular expression to limit number of characters to 10](https://stackoverflow.com/questions/1649435/regular-expression-to-limit-number-of-characters-to-10)
* [javascript.info - Anchors: string start ^ and end $](https://javascript.info/regexp-anchors)
